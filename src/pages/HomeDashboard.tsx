        ...
        >
          ...
          {urgentExam && (
            <motion.div
              ...
              className="bg-secondary rounded-xl p-4 flex items-center gap-3 cursor-pointer active:scale-[0.98] transition-transform"
            ...
            <motion.div variants={staggerItem}>
              ...
              <div className="flex gap-3 overflow-x-auto pb-1 -mx-1 px-1">
                {upcoming.map((s) => (
                  <div
                    key={s.id}
                    className="bg-card rounded-xl p-3 min-w-[140px] border shrink-0"
                  >
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <button
                  ...
                  className="bg-card border rounded-xl p-4 flex flex-col items-center gap-2 active:scale-[0.96] transition-transform"
                >
            ...
            {isLoading ? (
              ...
              <div className="bg-card border border-dashed rounded-xl p-6 text-center">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 bg-primary text-primary-foreground rounded-xl px-4 py-2 text-sm font-medium active:scale-[0.97] transition-transform"
                >
              ...
              <div className="grid grid-cols-2 gap-3">
                {subjects.map((s) => {
                  ...
                  return (
                    <button
                      ...
                      className="bg-card border rounded-xl p-4 text-left relative overflow-hidden active:scale-[0.97] transition-transform"
                    >
                ...
                <button
                  onClick={() => navigate("/subjects/add")}
                  className="bg-card border border-dashed rounded-xl p-4 flex flex-col items-center justify-center gap-2 text-muted-foreground active:scale-[0.97] transition-transform"
                >
