        ...
        >
          ...
          <motion.div variants={staggerItem} className="space-y-1">
            <button
              ...
              className="w-full text-left px-4 py-3.5 text-sm font-medium rounded-xl hover:bg-muted active:bg-muted transition-colors flex items-center justify-between"
            >
            ...
            {[
              ...
              <button
                ...
                className="w-full text-left px-4 py-3.5 text-sm font-medium rounded-xl hover:bg-muted active:bg-muted transition-colors"
              >
                {item.label}
              </button>
            ))}
